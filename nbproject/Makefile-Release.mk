...
${OBJECTDIR}/ESU_nomain.o: ${OBJECTDIR}/ESU.o ESU.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ESU_nomain.o ESU.cpp;\
	else  \
...
${OBJECTDIR}/NautyLink_nomain.o: ${OBJECTDIR}/NautyLink.o NautyLink.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NautyLink_nomain.o NautyLink.cpp;\
	else  \
...
${OBJECTDIR}/RandESU_nomain.o: ${OBJECTDIR}/RandESU.o RandESU.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RandESU_nomain.o RandESU.cpp;\
	else  \
...
${OBJECTDIR}/RandomGraphAnalysis_nomain.o: ${OBJECTDIR}/RandomGraphAnalysis.o RandomGraphAnalysis.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RandomGraphAnalysis_nomain.o RandomGraphAnalysis.cpp;\
	else  \
...
${OBJECTDIR}/RandomGraphGenerator_nomain.o: ${OBJECTDIR}/RandomGraphGenerator.o RandomGraphGenerator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RandomGraphGenerator_nomain.o RandomGraphGenerator.cpp;\
	else  \
...
${OBJECTDIR}/StatisticalAnalysis_nomain.o: ${OBJECTDIR}/StatisticalAnalysis.o StatisticalAnalysis.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StatisticalAnalysis_nomain.o StatisticalAnalysis.cpp;\
	else  \
...
${OBJECTDIR}/Subgraph_nomain.o: ${OBJECTDIR}/Subgraph.o Subgraph.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Subgraph_nomain.o Subgraph.cpp;\
	else  \
...
${OBJECTDIR}/SubgraphCount_nomain.o: ${OBJECTDIR}/SubgraphCount.o SubgraphCount.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SubgraphCount_nomain.o SubgraphCount.cpp;\
	else  \
...
${OBJECTDIR}/SubgraphProfile_nomain.o: ${OBJECTDIR}/SubgraphProfile.o SubgraphProfile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SubgraphProfile_nomain.o SubgraphProfile.cpp;\
	else  \
...
${OBJECTDIR}/nauty/gtools_nomain.o: ${OBJECTDIR}/nauty/gtools.o nauty/gtools.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nauty/gtools_nomain.o nauty/gtools.c;\
	else  \
...
${OBJECTDIR}/nauty/naugraph_nomain.o: ${OBJECTDIR}/nauty/naugraph.o nauty/naugraph.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nauty/naugraph_nomain.o nauty/naugraph.c;\
	else  \
...
${OBJECTDIR}/nauty/naurng_nomain.o: ${OBJECTDIR}/nauty/naurng.o nauty/naurng.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nauty/naurng_nomain.o nauty/naurng.c;\
	else  \
...
${OBJECTDIR}/nauty/nausparse_nomain.o: ${OBJECTDIR}/nauty/nausparse.o nauty/nausparse.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nauty/nausparse_nomain.o nauty/nausparse.c;\
	else  \
...
${OBJECTDIR}/nauty/nautil_nomain.o: ${OBJECTDIR}/nauty/nautil.o nauty/nautil.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nauty/nautil_nomain.o nauty/nautil.c;\
	else  \
...
${OBJECTDIR}/nauty/nautinv_nomain.o: ${OBJECTDIR}/nauty/nautinv.o nauty/nautinv.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nauty/nautinv_nomain.o nauty/nautinv.c;\
	else  \
...
${OBJECTDIR}/nauty/naututil_nomain.o: ${OBJECTDIR}/nauty/naututil.o nauty/naututil.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nauty/naututil_nomain.o nauty/naututil.c;\
	else  \
...
${OBJECTDIR}/nauty/nauty_nomain.o: ${OBJECTDIR}/nauty/nauty.o nauty/nauty.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nauty/nauty_nomain.o nauty/nauty.c;\
	else  \
...
${OBJECTDIR}/nauty/schreier_nomain.o: ${OBJECTDIR}/nauty/schreier.o nauty/schreier.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nauty/schreier_nomain.o nauty/schreier.c;\
	else  \
...
${OBJECTDIR}/nauty/sorttemplates_nomain.o: ${OBJECTDIR}/nauty/sorttemplates.o nauty/sorttemplates.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nauty/sorttemplates_nomain.o nauty/sorttemplates.c;\
	else  \
